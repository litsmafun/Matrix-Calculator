    ...
    try {
        ...
        switch (choice) {
            ...
            case 5: { // 矩阵加法
                ...
                auto result = operations->add(*currentMatrix, *b);
                // 自动判断结果矩阵是否需要转换类型
            ...
            case 6: { // 矩阵减法
                ...
                std::string filename = ui->getString();
                auto b = factory->loadFromFile(filename);
                auto result = operations->sub(*currentMatrix, *b);
                // 自动判断结果矩阵是否需要转换类型
                currentMatrix = factory->createMatrixAuto(*result);
            ...
            case 7: { // 矩阵乘法
                ...
                std::string filename = ui->getString();
                auto b = factory->loadFromFile(filename);
                auto result = operations->dot(*currentMatrix, *b);
                // 自动判断结果矩阵是否需要转换类型
                currentMatrix = factory->createMatrixAuto(*result);
            ...
            case 8: { // 矩阵转置
                ...
                auto result = operations->transpose(*currentMatrix);
                // 自动判断结果矩阵是否需要转换类型
                currentMatrix = factory->createMatrixAuto(*result);
            ...
            case 9: { // 矩阵求逆
                ...
                auto result = operations->inverse(*currentMatrix);
                // 自动判断结果矩阵是否需要转换类型
                currentMatrix = factory->createMatrixAuto(*result);
            ...
            case 11: { // 向量叉积(3D)
                ...
                std::string filename = ui->getString();
                auto b = factory->loadFromFile(filename);
                auto result = operations->cross(*currentMatrix, *b);
                // 自动判断结果矩阵是否需要转换类型
                currentMatrix = factory->createMatrixAuto(*result);
